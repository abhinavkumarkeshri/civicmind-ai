...
import { Lock, Mail, ArrowRight, AlertCircle, Clock, XCircle, ArrowLeft } from 'lucide-react'
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-400">Manage municipal complaints in your jurisdiction</p>
          </div>
        </div>
          ...
          <div
            className={`mb-6 p-4 rounded-lg border flex items-start gap-3 ${
              error.type === 'pending'
                ...
                : error.type === 'suspended' || error.type === 'rejected'
            ...
            <div>
              <p
                className={`text-sm font-medium ${
                  error.type === 'pending' ? 'text-amber-300' : 'text-red-300'
                }`}
              >
                {error.message}
              </p>
